...
function Hero({ dark }: { dark: boolean }) {
  ...
  return (
    <section
      data-scroll
      className="snap-start relative flex w-full text-white h-screen"
    >
      <div className="absolute bottom-[17%] z-30  left-[7%]">
        ...
        >
          <h1
            className={`${
              dark ? "text-orange-300" : "text-slate-600"
            }  text-5xl font-bold`}
          >
            Velotum 2023
          </h1>
      ...
      <div
        className={`absolute top-[27%] right-[5%] flex flex-col ${
          dark ? "text-white" : "text-slate-600"
        }`}
      >
        <div>
